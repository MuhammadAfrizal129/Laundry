...
Route::group(['prefix' => '/admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::get('/datatransaksi/{id}', 'TransaksiController@editdata')->name('edittransaksi');
    Route::post('/datatransaksi/{id}', 'TransaksiController@updatedata')->name('updatetransaksi');

    Route::get('/datatransaksi/laporan', 'TransaksiController@cetak_pdf');
...
Route::group(['prefix' => '/kasir', 'middleware' => ['auth', 'kasir']], function () {
    ...
    Route::get('/homeOwner', 'HomeController@indexOwner')->name('owner/homeOwner');
