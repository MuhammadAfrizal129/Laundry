                ...
                <div class="app-header-center bg-dark text-white">
                    ...
                    <ul class="header-menu nav b-p">
                        <li class="nav-item text-white">
                            <a href="{{ url('/kasir/homeKasir')}}" class="nav-link text-white">
                                <i class="nav-link-icon fa fa-home"> </i>
                                Home
                            </a>
                        <li class="nav-item">
                            <a href="{{ url('/kasir/datatransaksi')}}" class="nav-link text-white">
                            <i class="nav-link-icon far fa-money-bill-alt"></i>
                                Transaksi
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('kasir/datamember')}}" class="nav-link text-white">
                                <i class="nav-link-icon fa fa-user"></i>
                                Pelanggan
                            </a>
                        </li>
